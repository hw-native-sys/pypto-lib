        ...
        with pl.auto_incore():
            for b_idx_0_out, (out_iter_1_outer,) in pl.range(0, 8, 1, init_values=(out_0,)):
                for b_idx_0_in, (out_iter_1_inner,) in pl.parallel(0, 8, 1, init_values=(out_iter_1_outer,)):
                    ...
                    out_3: pl.Tensor[[64, 128], pl.FP32] = pl.tensor.assemble(out_iter_1_inner, oi_0, [cur_offset_0, 0])
                    out_iter_1_inner_rv: pl.Tensor[[64, 128], pl.FP32] = pl.yield_(out_3)
                out_iter_1_outer_rv: pl.Tensor[[64, 128], pl.FP32] = pl.yield_(out_iter_1_inner_rv)
