    ...
    def qwen3_decode_layer(self, hidden_states_0: pl.Tensor[[16, 5120], pl.BF16], seq_lens_0: pl.Tensor[[16], pl.INT32], rope_cos_0: pl.Tensor[[4096, 128], pl.FP32], rope_sin_0: pl.Tensor[[4096, 128], pl.FP32], k_cache_0: pl.Tensor[[524288, 128], pl.BF16], v_cache_0: pl.Tensor[[524288, 128], pl.BF16], input_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], wq_0: pl.Tensor[[5120, 5120], pl.BF16], wk_0: pl.Tensor[[5120, 1024], pl.BF16], wv_0: pl.Tensor[[5120, 1024], pl.BF16], wo_0: pl.Tensor[[5120, 5120], pl.BF16], post_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], w_gate_0: pl.Tensor[[5120, 25600], pl.BF16], w_up_0: pl.Tensor[[5120, 25600], pl.BF16], w_down_0: pl.Tensor[[25600, 5120], pl.BF16], out_0: pl.Tensor[[16, 5120], pl.BF16]) -> pl.Tensor[[16, 5120], pl.BF16]:
        ...
        with pl.auto_incore():
            ...
            for b0_0, (k0_iter_1, k_proj_iter_1, kb_iter_1, q_proj_iter_1, v_proj_iter_1, x_chunk_iter_1) in pl.range(0, 16, 4, init_values=(k0_0, k_proj_0, kb_0, q_proj_0, v_proj_0, x_chunk_0)):
                ...
                for ob_0_out, (k0_iter_3_outer, kb_iter_3_outer, q_proj_iter_3_outer, x_chunk_iter_3_outer) in pl.parallel(20, init_values=(k0_iter_1, kb_iter_1, q_proj_iter_1, x_chunk_iter_1)):
                    for ob_0_in, (k0_iter_3_inner, kb_iter_3_inner, q_proj_iter_3_inner, x_chunk_iter_3_inner) in pl.parallel(4, init_values=(k0_iter_3_outer, kb_iter_3_outer, q_proj_iter_3_outer, x_chunk_iter_3_outer)):
                        ...
                        for kb_5, (k0_iter_5, q_acc_iter_2, x_chunk_iter_5) in pl.range(20, init_values=(k0_iter_3_inner, q_acc_1, x_chunk_iter_3_inner)):
                        ...
                        q_proj_5: pl.Tensor[[16, 5120], pl.BF16] = pl.tensor.assemble(q_proj_iter_3_inner, _t8, [b0_0, q0_0])
                ...
                for ob_1_out, (gamma_iter_1_outer, k0_iter_8_outer, k_proj_iter_3_outer, kb_iter_6_outer, normed_iter_1_outer, v_proj_iter_3_outer, x_chunk_iter_8_outer, x_chunk_bf16_iter_1_outer) in pl.parallel(4, init_values=(gamma_0, k0_iter_3_outer_rv, k_proj_iter_1, kb_iter_3_outer_rv, normed_0, v_proj_iter_1, x_chunk_iter_3_outer_rv, x_chunk_bf16_0)):
                    for ob_1_in, (gamma_iter_1_inner, k0_iter_8_inner, k_proj_iter_3_inner, kb_iter_6_inner, normed_iter_1_inner, v_proj_iter_3_inner, x_chunk_iter_8_inner, x_chunk_bf16_iter_1_inner) in pl.parallel(8, init_values=(gamma_iter_1_outer, k0_iter_8_outer, k_proj_iter_3_outer, kb_iter_6_outer, normed_iter_1_outer, v_proj_iter_3_outer, x_chunk_iter_8_outer, x_chunk_bf16_iter_1_outer)):
                        ...
                        for kb_8, (gamma_iter_3, k0_iter_10, k_acc_iter_2, normed_iter_3, v_acc_iter_2, x_chunk_iter_10, x_chunk_bf16_iter_3) in pl.range(20, init_values=(gamma_iter_1_inner, k0_iter_8_inner, k_acc_1, normed_iter_1_inner, v_acc_1, x_chunk_iter_8_inner, x_chunk_bf16_iter_1_inner)):
                        ...
                        k_proj_5: pl.Tensor[[16, 1024], pl.BF16] = pl.tensor.assemble(k_proj_iter_3_inner, _t12, [b0_0, kv0_0])
                        _t13: pl.Tensor[[4, 32], pl.BF16] = pl.tensor.cast(v_acc_3, target_type=pl.BF16, mode='round')
                        v_proj_5: pl.Tensor[[16, 1024], pl.BF16] = pl.tensor.assemble(v_proj_iter_3_inner, _t13, [b0_0, kv0_0])
        ...
        for b_0, (attn_out_iter_1, k_cache_iter_1, v_cache_iter_1) in pl.parallel(16, init_values=(attn_out_0, k_cache_0, v_cache_0), chunk=4):
            ...
            with pl.auto_incore():
                ...
                for h_0_out, (attn_row_iter_2_outer, kvh_iter_1_outer) in pl.parallel(8, init_values=(attn_row_1, kvh_0)):
                    for h_0_in, (attn_row_iter_2_inner, kvh_iter_1_inner) in pl.parallel(8, init_values=(attn_row_iter_2_outer, kvh_iter_1_outer)):
        ...
        with pl.auto_incore():
            for b0_1, (gamma_iter_6, inv_rms_iter_1, k0_iter_13, kb_iter_9, normed_iter_6, ob_iter_2, out_iter_1, sq_sum_iter_5, x_chunk_iter_13) in pl.range(0, 16, 4, init_values=(gamma_iter_1_outer_rv, inv_rms_0, k0_2, kb_2, normed_iter_1_outer_rv, ob_1, out_0, sq_sum_3, x_chunk_2)):
                ...
                for ob_4_out, (k0_iter_15_outer, kb_iter_11_outer, resid1_tile_iter_1_outer) in pl.parallel(10, init_values=(k0_iter_13, kb_iter_9, resid1_tile_0)):
                    for ob_4_in, (k0_iter_15_inner, kb_iter_11_inner, resid1_tile_iter_1_inner) in pl.parallel(8, init_values=(k0_iter_15_outer, kb_iter_11_outer, resid1_tile_iter_1_outer)):
                        ...
                        for kb_13, (k0_iter_17, o_acc_iter_2) in pl.range(20, init_values=(k0_iter_15_inner, o_acc_1)):
                ...
                for kb_14, (k0_iter_20, sq_sum_iter_9, x_chunk_iter_15) in pl.range(20, init_values=(k0_iter_15_outer_rv, sq_sum_8, x_chunk_iter_13)):
                    k0_22: pl.Scalar[pl.INDEX] = kb_14 * 256
                    x_chunk_17: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.slice(resid1_tile_iter_1_outer_rv, [4, 256], [0, k0_22])
                ...
                for kb_15, (gamma_iter_8, k0_iter_23, normed_iter_8, post_norm_tile_iter_1, x_chunk_iter_18) in pl.range(20, init_values=(gamma_iter_6, k0_21, normed_iter_6, post_norm_tile_0, x_chunk_16)):
                    ...
                    x_chunk_20: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.slice(resid1_tile_iter_1_outer_rv, [4, 256], [0, k0_25])
                ...
                for ob_5, (down_proj_tile_iter_2, k0_iter_26, kb_iter_16, o0_iter_1) in pl.range(800, init_values=(down_proj_tile_1, k0_24, kb_15, o0_0)):
                    ...
                    for dob_0_out, (down_proj_tile_iter_4_outer,) in pl.parallel(20, init_values=(down_proj_tile_iter_2,)):
                        for dob_0_in, (down_proj_tile_iter_4_inner,) in pl.parallel(4, init_values=(down_proj_tile_iter_4_outer,)):
                            d0_0: pl.Scalar[pl.INDEX] = (0 + (dob_0_out * 4 + dob_0_in) * 1) * 64
                            down_prev_0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(down_proj_tile_iter_4_inner, [4, 64], [0, d0_0])
                ...
                for ob_6_out, (o0_iter_4_outer, out_iter_3_outer) in pl.parallel(20, init_values=(o0_2, out_iter_1)):
                    for ob_6_in, (o0_iter_4_inner, out_iter_3_inner) in pl.parallel(4, init_values=(o0_iter_4_outer, out_iter_3_outer)):
                        ...
                        _t59: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(resid1_tile_iter_1_outer_rv, [4, 64], [0, o0_6])
                        ...
                        out_5: pl.Tensor[[16, 5120], pl.BF16] = pl.tensor.assemble(out_iter_3_inner, _t60, [b0_1, o0_6])
