...
// Standalone attention entry (no rope prologue, no cross-core sync). Defines
// QWEN_FAI_ATTENTION_ONLY_ABI so fai_body.hpp compiles run_qwen_fai with the
// attention-only arg layout (0..7) and skips the rope_qkv producer. Used by the
// paged_attention_only_cce extern + test_paged_attention_cce.py.
...
#define QWEN_FAI_ATTENTION_ONLY_ABI
