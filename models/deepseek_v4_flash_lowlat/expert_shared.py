...
intermediate slice; ``moe`` all-reduces it across the TP group.
"""


import pypto.language as pl

from config import (FLASH as M, MOE_TOKENS, TP, INT8_SCALE_MAX, INT8_AMAX_EPS)
...
MM_INTER_TILE = min(256, max(32, MOE_INTER // 4))
ACT_INTER_TILE = min(1024, MOE_INTER)
D_OUT_TILE = 256
# h_tile_i8 stores use a whole number of a2a3 512-byte L2 cache lines.
QUANT_TILE = min(2048, MOE_INTER)
D_OUT_TILE_ACT = 512
W2_ACT_INNER = 8
