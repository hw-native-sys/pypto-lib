...
def make_forward_metadata_tensors(
    ...
    init_by_name = {
        ...
        "hca_cmp_slot_mapping": lambda: ranked(lambda: init_compressed_slot_mapping_single(HCA_COMPRESS_RATIO, HCA_CMP_STORAGE_BLOCK_SIZE, CSA_CMP_MAX_BLOCKS, cmp_block_num)),
        "csa_cmp_slot_mapping": lambda: ranked(lambda: init_compressed_slot_mapping_single(CSA_COMPRESS_RATIO, CSA_CMP_STORAGE_BLOCK_SIZE, CSA_CMP_MAX_BLOCKS, cmp_block_num)),
        "csa_idx_slot_mapping": lambda: ranked(lambda: init_compressed_slot_mapping_single(CSA_COMPRESS_RATIO, CSA_CMP_STORAGE_BLOCK_SIZE, CSA_IDX_CACHE_MAX_BLOCKS, idx_block_num)),
