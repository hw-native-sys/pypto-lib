...
size: 2/4/8/16 run N-rank distributed; each rank keeps 32 experts by default.
--experts-per-rank 16 selects the balanced EPLB performance fixture."""
...
_EP_DEFAULT = 2
_EXPERTS_PER_RANK_CHOICES = (16, 32)
...
if EP not in _EP_CHOICES or EXPERTS_PER_RANK not in _EXPERTS_PER_RANK_CHOICES:
    raise ValueError("unsupported EP size or experts-per-rank specialization")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--experts-per-rank", type=int, default=_EXPERTS_PER_RANK_DEFAULT,
                        choices=_EXPERTS_PER_RANK_CHOICES,
                        help="Local expert count; 16 selects the EPLB fixture")
