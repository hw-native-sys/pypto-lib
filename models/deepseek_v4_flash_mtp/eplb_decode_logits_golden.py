...
def _hca_attention_views(
    ...
    views["cmp_freqs_cos"] = tensors["cmp_freqs_cos"][rank, 1]
    views["cmp_freqs_sin"] = tensors["cmp_freqs_sin"][rank, 1]
...
def _csa_attention_views(
    ...
    views = _base_attention_views(tensors, rank, layer, x_hc, x_out)
    order = KIND_ORDER[layer]
    views["cmp_freqs_cos"] = tensors["cmp_freqs_cos"][rank, 0]
    views["cmp_freqs_sin"] = tensors["cmp_freqs_sin"][rank, 0]
