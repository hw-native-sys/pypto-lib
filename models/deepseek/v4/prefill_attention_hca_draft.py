...
"""DeepSeek-V4 prefill attention_hca scaffold.
...
from decode_attention_hca import *  # noqa: F401,F403
from decode_attention_hca import build_tensor_specs as _build_tensor_specs
...
def golden_prefill_attention_hca(tensors):
    """Non-distributed HCA prefill attention.

    Uses the same local causal attention output as the official prefill
