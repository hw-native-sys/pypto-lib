...
def decode_layer(
    ...
    csa_idx_wq_b_scale: pl.Tensor[[Q_LORA // 32, CSA_IDX_N_HEADS * CSA_IDX_HEAD_DIM], pl.FP8E8M0, pl.MX_B_NN],
...
def l3_decode_layer(
    ...
    csa_idx_wq_b_scale: pl.Tensor[[N_RANKS, Q_LORA // 32, CSA_IDX_N_HEADS * CSA_IDX_HEAD_DIM], pl.FP8E8M0],
...
def build_tensor_specs(
    ...
    attention_specs = [
        ...
        ("wq_a", active_specs["wq_a"]), ('wq_a_scale', active_specs['wq_a_scale']),
        ("wq_b", active_specs["wq_b"]),
        ("wq_b_scale", active_specs["wq_b_scale"]),
        ("wkv", active_specs["wkv"]), ('wkv_scale', active_specs['wkv_scale']),
        ...
        ("wo_a", active_specs["wo_a"]), ('wo_a_scale', active_specs['wo_a_scale']),
