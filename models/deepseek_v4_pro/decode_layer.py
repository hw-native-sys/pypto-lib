...
def decode_layer(
    ...
    csa_idx_wq_b_scale: pl.Tensor[[CSA_IDX_WQB_SCALE_ROWS, CSA_IDX_MX_N_TILE], pl.FP8E8M0],
...
def l3_decode_layer(
    ...
    csa_idx_wq_b_scale: pl.Tensor[[N_RANKS, CSA_IDX_WQB_SCALE_ROWS, CSA_IDX_MX_N_TILE], pl.FP8E8M0],
...
def build_tensor_specs(
    ...
    RESIDENT_WEIGHT_NAMES = replicated_attention | {
        ...
        # Packed FP4 tensors cannot use stacked resident storage: their logical
        # first dimension differs from the packed physical buffer dimension.
