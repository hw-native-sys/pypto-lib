...
# ci-reason: full-network forward: same as decode_fwd.py -- the fixtures do not fit this box and the run cannot
#   finish inside --max-time 900 (generate inputs alone ~280s). Timed out in every nightly on record. Run it
#   by hand on a machine with the headroom.
