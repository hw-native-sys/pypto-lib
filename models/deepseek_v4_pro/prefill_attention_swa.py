...
# intermediates overflow the runtime's default ring output heap (256 MiB per
# ring), which surfaces as `orch_error_code=2 HEAP_RING_DEADLOCK`. Ring sizing is
# per dispatch, through run_jit's runtime_cfg below -- simpler #1980 retired the
# process-wide PTO2_RING_* env vars this used to set, and nothing reads them now.
