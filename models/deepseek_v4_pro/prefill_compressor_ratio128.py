...
def prefill_compressor_ratio128(
    ...
    for proj_idx in pl.spmd(PACKED_C128_PROJ_BLOCKS, name_hint="prefill_hca_c128_kv_score_proj", deps=[late_dep]):
    ...
    with pl.at(level=pl.Level.CORE_GROUP, name_hint="prefill_hca_c128_rmsnorm_rope"):
        ...
        for norm_kb in pl.pipeline(NOPE_HEAD_DIM // HEAD_TILE, stage=2):
            ...
            normed_chunk: pl.Tensor[[HCA_C128_RMS_TILE, HEAD_TILE], pl.FP32] = pl.col_expand_mul(pl.row_expand_mul(kv_norm_chunk, inv_rms), gamma)
        ...
        rope_rot = pl.full([HCA_C128_RMS_TILE, ROPE_HEAD_DIM], dtype=pl.FP32, value=0.0)
