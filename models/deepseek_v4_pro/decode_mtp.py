...
def _projection_specs():
    ...
    return {
        ...
        "e_proj_w": TensorSpec(
            "e_proj_w", [N_RANKS, D, D], torch.float8_e4m3fn, init_value=init_e_proj_w
        ),
        "e_proj_w_scale": TensorSpec(
            "e_proj_w_scale",
            [N_RANKS, MTP_MX_SCALE_ROWS, MTP_OUT_CHUNK],
        ...
        "h_proj_w": TensorSpec(
            "h_proj_w", [N_RANKS, D, D], torch.float8_e4m3fn, init_value=init_h_proj_w
        ),
