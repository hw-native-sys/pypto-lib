...
def prefill_fwd(
    ...
    logit_row_indices: pl.Tensor[[MAX_LOGIT_ROWS], pl.INT32],
    hidden_workspace: pl.Out[pl.Tensor[[FWD_GROUP_TOKENS_DYN, D], pl.BF16]],
...
def l3_prefill_fwd(
    ...
    hidden_workspace: pl.Out[pl.Tensor[[N_RANKS, FWD_GROUP_TOKENS_DYN, D], pl.BF16]],
...
def compare_functions():
    ...
    finite_names = {
        "x_hc", "attn_stage",
        "o_proj_wo_a_full", "o_proj_wo_b_full",
        "x_mixed", "post_ffn", "comb_ffn", "ffn_out", "hidden_workspace",
        "kv_cache", "hca_cmp_kv", "csa_cmp_kv",
        "hca_compress_state", "csa_compress_state", "csa_inner_compress_state",
        "idx_kv_cache", "idx_kv_scale",
    }
