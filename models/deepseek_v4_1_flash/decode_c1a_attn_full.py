...
def golden_decode_c1a_attn_reuse(
    x: torch.Tensor,
    wq_a: torch.Tensor,
...
def golden_decode_c1a_attn_reindex(
    x: torch.Tensor,
    wq_a: torch.Tensor,
    wq_a_scale: torch.Tensor,
    q_norm_weight: torch.Tensor,
...
def golden_decode_c1a_attn_full(
    x: torch.Tensor,
    wq_a: torch.Tensor,
    wq_a_scale: torch.Tensor,
    q_norm_weight: torch.Tensor,
...
__all__ = [
    ...
    "golden_decode_c1a_attn_reindex",
...
def main():
    ...
    run_c1a("full", make_program, golden_decode_c1a_attn_full)
