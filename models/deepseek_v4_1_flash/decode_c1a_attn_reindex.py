...
__all__ = ["golden_decode_c1a_attn_reindex", "decode_c1a_attn_reindex"]


@pl.jit
def decode_c1a_attn_reindex_test(
    x: pl.Tensor[[T_DYN, D], pl.BF16],
    wq_a: pl.Tensor[[D, Q_LORA], pl.FP8E4M3FN],
    wq_a_scale: pl.Tensor[[D // 32, Q_LORA], pl.FP8E8M0, pl.MX_B_NN],
    q_norm_weight: pl.Tensor[[Q_LORA], pl.BF16],
    ...
    return decode_c1a_attn_reindex(
...
def main():
    ...
    run_c1a("reindex", make_program, golden_decode_c1a_attn_reindex)
