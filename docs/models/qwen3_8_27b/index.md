...
`models/qwen3_8_27b/` implements the whole **Gated DeltaNet block** of
Qwen3.8-27B, generated by PyPTO: fourteen operators and the block that composes
them, hidden states in and hidden states out, with the four projections around
the delta rule in W8A8. It is under development -- variable-length batching and
everything in the model outside this block are not written.
