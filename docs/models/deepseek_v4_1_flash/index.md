...
python models/deepseek_v4_1_flash/decode_c1a_attn_reindex.py
```
...
| Decoder C1A Full | `prefill_c1a_full.py`, `decode_c1a_attn_full.py` (attention), `decode_c1a_full.py` (mHC entry) |
| Decoder C1A Reindex | `prefill_c1a_reindex.py`, `decode_c1a_attn_reindex.py` (attention), `decode_c1a_reindex.py` (mHC entry) |
| Decoder C1A Reuse | `prefill_c1a_reuse.py`, `decode_c1a_attn_reuse.py` (attention), `decode_c1a_reuse.py` (mHC entry) |
...
Each decoder C1A mode keeps its attention operator in `decode_c1a_attn_*.py` and
