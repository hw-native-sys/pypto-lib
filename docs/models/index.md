...
| [qwen3_8_27b](qwen3_8_27b/index.md) | The Gated DeltaNet linear-attention layer of Qwen3.8-27B: six operators and the layer composing them; the projections around it are not written yet, so it is under development | Not supported |
